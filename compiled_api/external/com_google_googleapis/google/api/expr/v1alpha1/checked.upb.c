...
static const upb_MiniTableField google_api_expr_v1alpha1_CheckedExpr__fields[5] = {
  ...
  {6, UPB_SIZE(20, 40), 0, kUpb_NoSub, 9, kUpb_FieldMode_Scalar | (kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
};
...
const upb_MiniTable google_api_expr_v1alpha1_CheckedExpr_msg_init = {
  ...
  UPB_SIZE(32, 56), 5, kUpb_ExtMode_NonExtendable, 0, UPB_FASTTABLE_MASK(56), 0,
  UPB_FASTTABLE_INIT({
