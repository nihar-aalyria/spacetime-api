...
static const upb_MiniTableField google_api_expr_v1alpha1_Expr_CreateList__fields[2] = {
  ...
  {2, UPB_SIZE(4, 8), 0, kUpb_NoSub, 5, kUpb_FieldMode_Array | kUpb_LabelFlags_IsPacked | (UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
};
...
static const upb_MiniTableField google_api_expr_v1alpha1_Expr_CreateStruct_Entry__fields[5] = {
  {1, UPB_SIZE(24, 32), 0, kUpb_NoSub, 3, kUpb_FieldMode_Scalar | (kUpb_FieldRep_8Byte << kUpb_FieldRep_Shift)},
  {2, 16, -5, kUpb_NoSub, 9, kUpb_FieldMode_Scalar | (kUpb_FieldRep_StringView << kUpb_FieldRep_Shift)},
  {3, 16, -5, 0, 11, kUpb_FieldMode_Scalar | (UPB_SIZE(kUpb_FieldRep_4Byte, kUpb_FieldRep_8Byte) << kUpb_FieldRep_Shift)},
...
const upb_MiniTable google_api_expr_v1alpha1_Expr_CreateStruct_Entry_msg_init = {
  ...
  UPB_FASTTABLE_INIT({
    ...
    {0x0010000402000012, &upb_pos_1bt},
    {0x001000040300001a, &upb_pom_1bt_max64b},
